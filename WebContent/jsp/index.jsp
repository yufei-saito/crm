	...
	<div class="container-fluid">
				...
				<c:forEach items="${hots}" var="p">
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						...
						<p><a href="${pageContext.request.contextPath}/ProductServlet?method=findById&pid=${p.pid}" style='color:#666'>${p.pname}</a></p>
	...
	<div class="container-fluid">
		...
		<div class="col-md-10">
			<div class="col-md-6"
				...
				<a href="product_info.htm"> <img src="products/hao/middle01.jpg"
			...
			<c:forEach items="${news}" var="p">
				<div class="col-md-2"
					...
					<a
						href="${pageContext.request.contextPath}/ProductServlet?method=findById&pid=${p.pid}">
