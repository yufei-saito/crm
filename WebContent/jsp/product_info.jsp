			...
			<div class="row">
				...
				<div style="margin:0 auto;width:950px;">
					...
					<div class="col-md-6">
						...
						<div style="margin:10px 0 10px 0;">商城价: <strong style="color:#ef0101;">￥：${product.shop_price}元/件</strong> 市场 价： <del>￥${product.market_price}元/件</del>
						</div>
						...
						<form  id="addCart" action="${pageContext.request.contextPath}/CartServlet?method=addCartItem" method="post">
						<div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
							...
							<div style="margin:20px 0 10px 0;;text-align: center;">
								...
								<a href="javascript:void(0)">
									<input  id="btn1"style="background: url('${pageContext.request.contextPath}/img/product.gif') no-repeat scroll 0 -600px rgba(0, 0, 0, 0);height:36px;width:127px;" value="加入购物车" type="button">
								</a> &nbsp;收藏商品</div>
						</div>
						</form>
					</div>
				...
				<div style="width:950px;margin:0 auto;">
					<div style="background-color:#d3d3d3;width:930px;padding:10px 10px;margin:10px 0 10px 0;">
						<strong>商品详情:<br/>${product.pdesc}</strong>
					</div>
